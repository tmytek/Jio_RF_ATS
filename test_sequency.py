...
class test_seq:
    ...
    def initialize(self, list_view, all_data, build_row, display_limit=12):
        ...
        try:
            ...
            import USB_4711A_JIO 
            tmp_result_4711 = self.daq = USB_4711A_JIO.DAQ_4711()
            ...
            if tmp_result_4711:
                ...
                print(f"=======tmp_result_EVM : {tmp_result_EVM}")
    ...
    def add_data(self, list_view, all_data, build_row, display_limit=12):
        ...
        # parameters
        EVM_tx_h_ch_lower = -99
        EVM_tx_h_ch_higher = -20
        EVM_tx_v_ch_lower = -99
        EVM_tx_v_ch_higher = -20
        EVM_rx_h_ch_lower = -99
        EVM_rx_h_ch_higher = -20
        EVM_rx_v_ch_lower = -99
        EVM_rx_v_ch_higher = -20
        Power_tx_h_ch_lower = -99
        Power_tx_h_ch_higher = -20
        Power_tx_v_ch_lower = -99
        Power_tx_v_ch_higher = -20
        Power_rx_h_ch_lower = -99
        Power_rx_h_ch_higher = -20
        Power_rx_v_ch_lower = -99
        Power_rx_v_ch_higher = -20
            ...
            for i_chain in range(1, 3):
                for i_IC_no in range(1, 5):
                    for i_channel in range(1, 5):
                        ...
                        # check EVM
                        self.evm_instrument.SET_EVM(10, 5)
                        ...
                        i_ch_power_result = "Pass" if ((i_ch_evm <= Power_tx_h_ch_higher)and(i_ch_evm >= Power_tx_h_ch_lower))  else "FAIL"
                        item = {
            ...
            for i_chain in range(1, 3):
                for i_IC_no in range(1, 5):
                    for i_channel in range(1, 5):
                        ...
                        i_ch_power_result = "Pass" if ((i_ch_evm <= Power_tx_v_ch_higher)and(i_ch_evm >= Power_tx_v_ch_lower))  else "FAIL"
                        item = {
            ...
            for i_chain in range(1, 3):
                for i_IC_no in range(1, 5):
                    for i_channel in range(1, 5):
                        ...
                        # check EVM
                        self.evm_instrument.SET_EVM(10, 10)
                        tmp = self.evm_instrument.GET_EVM()
                        i_ch_evm = round(tmp[0], 3)
                        i_ch_power = round(tmp[1], 3)
                        i_ch_evm_result = "Pass" if ((i_ch_evm <= EVM_rx_h_ch_higher)and(i_ch_evm >= EVM_rx_h_ch_lower))  else "FAIL"
                        i_ch_power_result = "Pass" if ((i_ch_evm <= Power_rx_h_ch_higher)and(i_ch_evm >= Power_rx_h_ch_lower))  else "FAIL"
                        item = {
            ...
            for i_chain in range(1, 3):
                for i_IC_no in range(1, 5):
                    for i_channel in range(1, 5):
                        ...
                        i_ch_power_result = "Pass" if ((i_ch_evm <= Power_rx_v_ch_higher)and(i_ch_evm >= Power_rx_v_ch_lower))  else "FAIL"
                        item = {
